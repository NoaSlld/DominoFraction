class SoustractionGenerator extends Generator {
    generate() {
        let dominos = []
        let i = 1;
        let aux = 0;
    ...
    createDomino(dominos, nb){
        ...
        let prodNum = numerator1*denominator2 - numerator2*denominator1
    ...
    createAndPushOneDomino(dominos, i, aux){
        ...
        let [numerator1, denominator1] = fraction1.split('/');
        let [numerator2, denominator2] = fraction2.split('/');
        // if (eval((eval(numerator1*h + g*denominator1)/eval(denominator1*h))) < eval(eval(numerator2*h - g*denominator2)/eval(denominator2*h))) {
